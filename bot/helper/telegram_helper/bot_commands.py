...
class _BotCommands:
    def __init__(self):
        ...
        self.ListCommand = (f'list{CMD_INDEX}', f's{CMD_INDEX}')
        self.SearchCommand = f'search{CMD_INDEX}'
        self.StatusCommand = (f'status{CMD_INDEX}', f'sall')
        ...
        self.PingCommand = (f'ping{CMD_INDEX}', f'p') 
        self.RestartCommand = (f'r{CMD_INDEX}', f'restartall')
